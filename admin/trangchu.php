    ...
    <header>
        ...
        <div class="menu-mobile">
            ...
            <div class="mau">
                ...
                <div class="cutxeo">
                    <img src="./img/4e30084eeb412b1f7250.jpg" alt="">
                </div>
                <p>Helo,..............</p>
                <div class="menu">
                    <div class="img_text">
                    ...
                    <div class="img_text">
                        <a href="./indexcoso.html"> <i class="fa-solid fa-table"></i> </a>
                        <a href="./indexcoso.html" id="abc">Cơ Sở</a>
                    </div>
                    <div class="img_text">
                        <a href="./indexhocsinh.html"> <i class="fa-solid fa-user"></i></a>
                        <a href="./indexhocsinh.html" id="abc">Học Sinh</a>
                    </div>
                    <div class="img_text">
                        <a href="./indexgiaovien.html"><i class="fa-solid fa-book-open-reader"></i></a>
